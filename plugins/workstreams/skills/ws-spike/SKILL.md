...
7. The spike is provisioned — do **not** print a bootstrap prompt. Offer **`/ws-resume <spike-id>`** now (opt-out; provisioned-spike handoff, §Next-step chaining). Spike resume is store-scoped — no worktree handoff.
