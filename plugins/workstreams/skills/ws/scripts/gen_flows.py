...
def generate_resume_mmd(gates: Optional[Dict[str, Any]] = None) -> str:
    ...
    class kind,kind_loop,check_terminal,check_needs,check_zero_tasks,check_plan_line,pre_plan_ext,check_tasks,check_followups,post_loop_ext,check_spike_complete condition;
    class resolve,unit_prep,spike_prep,blocked_guard,phase_py,plan,plan_save,confirm_plan,loop,unit_exec,spike_exec,check_off,spike_check_off,blocked action;
