...
3. Create the empty ledger `units.md` (header line only), the `units/` directory, `backlog.md` with both headings present and empty, and `focus.md` with a `## Focus` header only.
